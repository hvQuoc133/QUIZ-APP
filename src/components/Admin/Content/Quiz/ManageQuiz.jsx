...
import AssigQuestion from '../Question/EditQuestion/AssigQuestion';
...
const ManageQuiz = (props) => {
    ...
    return (
        <div className="quiz-container">
            ...
            {/*List Quiz */}
            <Tabs defaultActiveKey="list" id="quiz-tabs">
                <Tab eventKey="list" title="List Quizzes">
                ...
                {/* Edit Quiz */}
                <Tab eventKey="editQuiz" title="Edit QA Quiz">
                    <EditQuestion />
                </Tab>

                {/* Assig Quiz */}
                <Tab eventKey="assignQuiz" title="Assign Users">
                    <AssigQuestion />
                </Tab>
            </Tabs>
        </div>
